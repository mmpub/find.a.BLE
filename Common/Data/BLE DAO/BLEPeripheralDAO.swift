...
internal final class BLEPeripheralDAO: MVVMD.DataAccessObject {
    ...
    func setCallbacks(  startInterrogation: @escaping StartInterrogationCallback,
                        cancelInterrogation: @escaping CancelInterrogationCallback) {
